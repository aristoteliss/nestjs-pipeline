...
/**
 * Pure domain exception thrown when an actor attempts an action or field modification
 * on a domain entity without the required authorization permissions.
 *
 * Completely decoupled from HTTP / framework primitives.
 */
