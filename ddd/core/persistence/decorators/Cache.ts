 ...
 * under the key from `setKeyFn`; if it returns `null` (e.g. a delete), the keys
 ...
 * @param deleteKeysFn - Builds the keys to evict when the save yields `null`, or `null` to skip eviction.
 */
