 ...
 *
 * Tenant comparison depends only on the application-facing {@link ITenantContext}
 * contract; persistence owns the concrete tenant storage implementation.
 */
@Injectable()
export class JwtAuthenticator {
  ...
  /** Imports an SPKI PEM-encoded public key for JWT verification. */
