...
import { currentTenantId } from '@nestjs-pipeline/ddd-core/application';
...
describe('TenantScopeBehavior', () => {
  ...
  it('runs the rest of the pipeline with the pipeline tenant as the ddd-core tenant', async () => {
