...
F-11 is a reproduced defect on this branch and is the next implementation target. N-01 and N-03 are closed. F-14, F-16 and F-17 remain open from code-path evidence. N-02, N-04, N-05, N-06 and N-07 remain open from this review, and D-04 records an owner decision on audit coverage.
