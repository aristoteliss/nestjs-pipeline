...
E-01 and E-02 are implemented. F-02, F-03, F-05, F-08 and F-10 are implemented, and F-01 is implemented except for its unversioned-adapter policy. S-01, S-02 and S-15 are shipped; A-04 and U-09 are closed; S-08, A-01 and U-10 are superseded by a real pipeline-cache consumer.

F-07 and F-11 are reproduced defects on this branch and are the next implementation targets, together with N-01. F-04, F-09, F-14, F-16 and F-17 remain open from code-path evidence. N-02 through N-06 are new findings from this review.
