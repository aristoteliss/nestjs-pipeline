> Reference source only: this parked copy of the previous `@nestjs-pipeline/casl` is not built, tested or published.
> It sits outside the pnpm workspace; the maintained package is `packages/pipeline-casl`.
